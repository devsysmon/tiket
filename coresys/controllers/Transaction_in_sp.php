...
class Transaction_in_sp extends MY_Controller {
	...
	public function get_data($merk) {
		...
		$query = "SELECT *, a.id as ids FROM master_transaction_in_sp a LEFT JOIN master_inventory b ON(a.kode_part=b.kode_part) $where";
	...
	public function totalDatas() {
		$query = $this->db->select("COUNT(*) as num")->get("master_transaction_in_sp");
        $result = $query->row();
