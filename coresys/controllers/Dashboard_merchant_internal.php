...
class Dashboard_merchant_internal extends MY_Controller {
	var $data = array();
	...
	public function get_client($id) {	
		...
		$this->data['id'] = $id;
		$this->data['data_client'] = $this->db->query("SELECT * FROM master_client")->result();
		$this->data['client'] = $this->db->query("SELECT * FROM master_client WHERE id='$id'")->row();
		$this->data['data_cabang'] = $this->db->query("SELECT * FROM master_client GROUP BY cabang")->result();
		$this->data['kunjungan'] = $this->kunjungan();
	
		return view('pages/dashboard_merchant_internal/get_client', $this->data);
	}
	
	public function view_child_atm() {
		if($this->uri->segment(3)!==null) {
			$this->data['id'] = $this->uri->segment(3);
		} else {
			$this->data['id'] = "";
		}
		return view('pages/dashboard_merchant_internal/table_atm', $this->data);
	}
	
	public function view_child_ticket() {
		return view('pages/dashboard_merchant_internal/table_ticket', $this->data);
	}
	
	public function view_child_attend() {
		return view('pages/dashboard_merchant_internal/table_attend', $this->data);
	}
	
	public function view_child_part() {
		return view('pages/dashboard_merchant_internal/table_part', $this->data);
	}
	
	public function view_child() {
		return view('pages/dashboard_merchant_internal/view_child', $this->data);
	}
