...
class Master_instruction extends CI_Controller {
	var $data = array();
	...
	public function add() {
		...
		return view('pages/master_instruction/form', $this->data);
	}
	
	public function edit($id) {
		$this->db->where("id", $id);
		$row = $this->db->get("master_instruction")->row();
	...
	public function insert() {
		...
		$data['level'] = $level;
		$result = $this->db->insert('master_instruction', $data);
