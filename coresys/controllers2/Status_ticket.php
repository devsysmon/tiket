...
class Status_ticket extends CI_Controller {
    var $data = array();
    ...
    public function show_table() {
		...
		foreach ($list as $d) {
			if($d['accept_time']=="" && $d['action_taken']=="") {
				...
				if($d['status']=="CLOSED") {
					$table_status = '<span class="badge_style b_done">Job Done</span><a href="'.base_url().'dashboard/detail/'.$d['ticket_id'].'"><span class="badge_style b_done">Detail</span></a>';
				} else if($d['status']=="PENDING") {
					$table_status = '<span class="badge_style b_away">Job PENDING</span>';
				} else if($d['status']=="SLM") {
