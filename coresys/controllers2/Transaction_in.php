...
class Transaction_in extends CI_Controller {
	var $data = array();
	var $data_temp = array();
	...
	public function get_data($merk) {
		...
		$query = "SELECT *, a.id as ids FROM master_transaction_in a LEFT JOIN master_inventory b ON(a.kode_part=b.kode_part) $where";
