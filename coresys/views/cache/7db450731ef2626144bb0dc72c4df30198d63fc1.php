	...
	<head>
		...
		<style>
			...
			.zoomsmall:hover {
			  ...
			  background: linear-gradient(to bottom, #323232 0%, #3F3F3F 0%, #1C1C1C 150%);
			}
			p.small {
			  line-height: 1.0;
			}
				...
				<ul>
					<?php
						function active($that, $currect_page){
							$url_array = explode("/", $that->uri->uri_string());
							$url = end($url_array);  
							if($currect_page == $url){
								echo "class='active'";
							} 
					...
					<li <?=active($that, 'dashboard')?> style="background: linear-gradient(to bottom, #323232 0%, #3F3F3F 0%, #1C1C1C 150%);">
						<a href="<?=base_url()?>dashboard.insan" title="" class="menu-item-parent zoomsmall">
					...
					<li <?=active($that, 'dashboard_merchant')?> style="background: linear-gradient(to bottom, #323232 0%, #3F3F3F 0%, #1C1C1C 150%);">
						<a href="<?=base_url()?>dashboard_merchant.insan" title="" class="menu-item-parent zoomsmall">
					...
					<li <?=active($that, 'monitor_atm')?> style="background: linear-gradient(to bottom, #323232 0%, #3F3F3F 0%, #1C1C1C 150%);">
						<a href="<?=base_url()?>monitor_atm.insan" title="" class="menu-item-parent zoomsmall">
					...
					<li <?=active($that, array('dashboard_merchant_internal', 'master_client', 'master_atm', 'master_lokasi'))?> style="background: linear-gradient(to bottom, #323232 0%, #3F3F3F 0%, #1C1C1C 150%)">
						...
						<ul>
							<li <?=active($that, 'dashboard_merchant_internal')?>>
								<a href="<?=base_url()?>dashboard_merchant_internal.insan" class="zoomsmall">Client Dashboard</a>
							</li>
							<li <?=active($that, 'master_client')?>>
								<a href="<?=base_url()?>master_client.insan" class="zoomsmall">Client & Customer</a>
							</li>
							<li <?=active($that, 'master_atm')?>>
								<a href="<?=base_url()?>master_atm.insan" class="zoomsmall">Data Mesin ATM</a>
							</li>
							<li <?=active($that, 'master_lokasi')?>>
								<a href="<?=base_url()?>master_lokasi.insan" class="zoomsmall">Area & Location</a>
							</li>
						</ul>
					</li>
					<li <?=active($that, array('master_petugas', 'master_attendance', 'master_user', 'master_absen_location'))?> style="background: linear-gradient(to bottom, #323232 0%, #3F3F3F 0%, #1C1C1C 150%)">
						<a href="#" class="zoomsmall">
						...
						<ul>
							<li <?=active($that, 'master_petugas')?>>
								<a href="<?=base_url()?>master_petugas.insan" class="zoomsmall">Petugas / Staff</a>
							</li>
							<li <?=active($that, 'master_attendance')?>>
								<a href="<?=base_url()?>master_attendance.insan" class="zoomsmall">Attendance</a>
							</li>
							<li <?=active($that, 'master_user')?>>
								<a href="<?=base_url()?>master_user.insan" class="zoomsmall">User Access</a>
							</li>
							<li <?=active($that, 'master_absen_location')?>>
								<a href="<?=base_url()?>master_absen_location.insan" class="zoomsmall">Setting Geolocation</a>
							</li>
						</ul>
					</li>
					<li <?=active($that, array('master_inventory', 'transaction_in', 'transaction_out'))?> style="background: linear-gradient(to bottom, #323232 0%, #3F3F3F 0%, #1C1C1C 150%)">
						...
						<ul>
							<li <?=active($that, 'master_inventory')?>>
								<a href="<?=base_url()?>master_inventory.insan" class="zoomsmall">Inventory Stock</a>
							</li>
							<li <?=active($that, 'transaction_in')?>>
								<a href="<?=base_url()?>transaction_in.insan" class="zoomsmall">Transaction In</a>
							</li>
							<li <?=active($that, 'transaction_out')?>>
								<a href="<?=base_url()?>transaction_out.insan" class="zoomsmall">Transaction Out</a>
							</li>
						</ul>
					</li>
					<li <?=active($that, array('trans_jadwal', 'trans_staff', 'master_item', 'master_news'))?> style="background: linear-gradient(to bottom, #323232 0%, #3F3F3F 0%, #1C1C1C 150%)">
						<a href="#" class="zoomsmall">
						...
						<ul>
							<li <?=active($that, 'trans_jadwal')?>>
								<a href="<?=base_url()?>trans_jadwal.insan" class="zoomsmall">Work Schedule</a>
							</li>
							<li <?=active($that, 'trans_staff')?>>
								<a href="<?=base_url()?>trans_staff.insan" class="zoomsmall">Switch Schedule</a>
							</li>
							<li <?=active($that, 'master_item')?>>
								<a href="<?=base_url()?>master_item.insan" class="zoomsmall">List Job Item</a>
							</li>
							<li <?=active($that, 'master_news')?>>
								<a href="<?=base_url()?>master_news.insan" class="zoomsmall">News Broadcast</a>
							</li>
						</ul>
					</li>		
					<li <?=active($that, array('new_ticket', 'status_ticket', 'master_jobcard', 'trouble_category', 'trouble_sub_category'))?> style="background: linear-gradient(to bottom, #323232 0%, #3F3F3F 0%, #1C1C1C 150%)">
						...
						<ul>
							<li <?=active($that, 'new_ticket')?>>
								<a href="<?=base_url()?>new_ticket.insan" class="zoomsmall">New Issue Tickets</a>
							</li>
							<li <?=active($that, 'status_ticket')?>>
								<a href="<?=base_url()?>status_ticket.insan" class="zoomsmall">Status Tickets</a>
							</li>
							<li <?=active($that, 'master_jobcard')?>>
								<a href="<?=base_url()?>master_jobcard.insan" class="zoomsmall">Data Jobcard</a>
							</li>
							<li <?=active($that, 'trouble_category')?>>
								<a href="<?=base_url()?>trouble_category.insan" class="zoomsmall">Trouble Category</a>
							</li>
							<li <?=active($that, 'trouble_sub_category')?>>
								<a href="<?=base_url()?>trouble_sub_category.insan" class="zoomsmall">Sub Trouble Category</a>
							</li>
						</ul>
					</li>		
					<li <?=active($that, array('report_attendance', 'inventory_report', 'report_maintenance', 'jobcard_report'))?> style="background: linear-gradient(to bottom, #323232 0%, #3F3F3F 0%, #1C1C1C 150%)">
						...
						<ul>
							<li <?=active($that, 'report_attendance')?>>
								<a href="<?=base_url()?>report_attendance.insan" class="zoomsmall">Attendance Report</a>
							</li>
							<li <?=active($that, 'inventory_report')?>>
								<a href="<?=base_url()?>inventory_report.insan" class="zoomsmall">Inventory Report</a>
							</li>
							<li <?=active($that, 'report_maintenance')?>>
								<a href="<?=base_url()?>report_maintenance.insan" class="zoomsmall">Technical Report</a>
							</li>
							<li <?=active($that, 'jobcard_report')?>>
								<a href="<?=base_url()?>jobcard_report.insan" class="zoomsmall">Jobcard Report</a>
							</li>
						</ul>
					</li>		
					<li style="background: linear-gradient(to bottom, #323232 0%, #3F3F3F 0%, #1C1C1C 150%);">
						<a href="<?=base_url()?>master_registry.insan" title="" class="menu-item-parent zoomsmall">
					...
					<li style="background: linear-gradient(to bottom, #323232 0%, #3F3F3F 0%, #1C1C1C 150%);">
						<a href="#" title="" class="menu-item-parent zoomsmall">
					...
					<li style="background: linear-gradient(to bottom, #323232 0%, #3F3F3F 0%, #1C1C1C 150%);">
						<a href="#" title="" class="menu-item-parent zoomsmall">
						<img style="float: left; margin: 0px 10px 0px 0px;" src="<?=base_url()?>seipkon/assets/img/jobcard.png" height="28" width="28" />
						<span class="menu-item-parent">
						<p class="small" style="">
							<small style="color:white;font-size:14px; margin: 0px 0px 0px 0px; font-weight: bold;">System License</small><br>
							<small style="color:white;font-size:10px;">Lisensi Penggunaan System</small>
						</p>
						</span>
						</a>
					</li>	
					<li style="background: linear-gradient(to bottom, #323232 0%, #3F3F3F 0%, #1C1C1C 150%);">
						<a href="#master_instruction" title="" class="menu-item-parent zoomsmall">
