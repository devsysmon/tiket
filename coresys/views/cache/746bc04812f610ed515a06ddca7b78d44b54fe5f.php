...
<div class="row">
	<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin: -20px 0px 0px 0px;">
		<div class="navbar navbar-default" style="background: linear-gradient(to bottom, #00c6ff, #0072ff);">
...
<section id="widget-grid">
	...
	<div class="row hrow-gap">
		<article class="col-sm-7" style="margin: -20px 0px 0px 0px;">
			<!-- new widget -->
		...
		<article class="col-sm-5" style="margin: -20px 0px 0px -31px;">
			<div class="navbar navbar-default" style="width:520px;">
			<div id="cc" class="easyui-layout" style="width:100%;height:354px;">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\2021\JAN-W3\ATMSERV-ASSINDO\coresys\views/pages/dashboard_merchant_internal/index.blade.php ENDPATH**/ ?>