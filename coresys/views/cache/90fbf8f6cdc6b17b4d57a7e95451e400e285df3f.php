						...
						<div class="widget-body widget-hide-overflow no-padding">
							...
							<div id="chat-container">
								...
								<div class="chat-list-body custom-scroll">
									<ul id="chat-users">
										<li>
											<a href="javascript:void(0);"><img src="<?=BASE_URL?>img/avatars/5.png" alt="">Robin Berry <span class="badge badge-inverse">23</span><span class="state"><i class="fa fa-circle txt-color-green pull-right"></i></span></a>
										</li>
										<li>
											<a href="javascript:void(0);"><img src="<?=BASE_URL?>img/avatars/male.png" alt="">Mark Zeukartech <span class="state"><i class="last-online pull-right">2hrs</i></span></a>
										</li>
										<li>
											<a href="javascript:void(0);"><img src="<?=BASE_URL?>img/avatars/male.png" alt="">Belmain Dolson <span class="state"><i class="last-online pull-right">45m</i></span></a>
										</li>
										<li>
											<a href="javascript:void(0);"><img src="<?=BASE_URL?>img/avatars/male.png" alt="">Galvitch Drewbery <span class="state"><i class="fa fa-circle txt-color-green pull-right"></i></span></a>
										</li>
										<li>
											<a href="javascript:void(0);"><img src="<?=BASE_URL?>img/avatars/male.png" alt="">Sadi Orlaf <span class="state"><i class="fa fa-circle txt-color-green pull-right"></i></span></a>
										</li>
										<li>
											<a href="javascript:void(0);"><img src="<?=BASE_URL?>img/avatars/male.png" alt="">Markus <span class="state"><i class="last-online pull-right">2m</i></span> </a>
										</li>
										<li>
											<a href="javascript:void(0);"><img src="<?=BASE_URL?>img/avatars/sunny.png" alt="">Sunny <span class="state"><i class="last-online pull-right">2m</i></span> </a>
										</li>
										<li>
											<a href="javascript:void(0);"><img src="<?=BASE_URL?>img/avatars/male.png" alt="">Denmark <span class="state"><i class="last-online pull-right">2m</i></span> </a>
										</li>
									</ul>
								</div>
							...
							<div id="chat-body" class="chat-body custom-scroll">
								<ul>
									<li class="message">
										<img src="<?=BASE_URL?>img/avatars/5.png" class="online" alt="">
									...
									<li class="message">
										<img src="<?=BASE_URL?>img/avatars/sunny.png" class="online" alt="">
										<div class="message-text">
											<time>
												2014-01-13
...
<?php echo $__env->make('layouts.master_template', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>