...
<?php $__env->startSection('content'); ?>
	...
	<section id="widget-grid" class="">
				...
				<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" data-widget-colorbutton="false" 
					...
					<div>
						...
						<div class="jarviswidget-editbox">
							...
							<a href="<?=base_url()?>master_lokasi.insan" class="btn btn-warning pull-right" style="border-radius: 5px;"><img style="float: left; margin: 0px 5px 0px 0px;" src="<?=base_url()?>seipkon/assets/img/navigation-180.png" height="20" width="20" />Back</a> 
		...
		<div class="container content_form" hidden>
			<form action="<?=base_url()?>master_lokasi_detail/insert" class="formName" style="margin-bottom: 10px">
			...
			*/	
			...
			/* BASIC ;*/
				...
				table = $('#dt_basic').DataTable({
					...
					"ajax":{
						url :  base_url + 'master_lokasi_detail/get_data/<?=$id?>',
						type : 'POST',
			...
			$.confirm({
				...
				onContentReady: function () {
					...
					this.$content.find('.data_atm').select2({
						...
						ajax: {
							dataType: 'json',
							url: '<?php echo base_url().'master_lokasi_detail/select_atm'?>',
							delay: 250,
							type: "POST",
