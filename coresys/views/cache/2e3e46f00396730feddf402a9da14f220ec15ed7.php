	...
	<hanzmobview>
		<article class="btn-group col-sm-12">
			<div class="navbar navbar-default" style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );border-radius: 5px 5px 0px 0px;">
				...
				<a href="new_ticket.ins" class="btn btn-default btn-circle btn-sm zoomsmall active">
	...
	<section id="widget-grid" class="">
		...
		<div class="container content_form" hidden>
			<form action="<?=base_url()?>new_ticket/insert" class="formName">
				<center><h5>CREATE NEW ISSUE TICKET <br>TICKET NUMBER : <span id="id_ticket"></span></h5></center><br>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\2021\JAN-W3\ATMSERV-ASSINDO\coresys\views/pages/new_ticket/index.blade.php ENDPATH**/ ?>