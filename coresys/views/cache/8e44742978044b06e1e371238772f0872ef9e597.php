...
<?php $__env->startSection('javascript'); ?>
	<script src="<?=BASE_URL?>js/plugin/delete-table-row/delete-table-row.min.js"></script>
	
	<script src="<?=BASE_URL?>js/plugin/summernote/summernote.min.js"></script>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			$("#compose-mail").click(function() {
				loadURL("<?=base_url()?>template/email/email_compose.html", $('#inbox-content > .table-wrap'));
			})
