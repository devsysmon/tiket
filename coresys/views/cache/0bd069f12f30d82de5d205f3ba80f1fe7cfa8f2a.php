...
<html lang="en-us">
	...
	<hanzmobview>	
		<ul class="exo-menu">
			...
			<div class="pull-right">
				...
				<div id="logout" class="btn-header transparent pull-right">
					<span> <a href="<?=base_url()?>login" title="Sign Out" data-action="userLogout" data-logout-msg="You can improve your security further after logging out by closing this opened browser"><i class="fa fa-sign-out"></i></a> </span>
				</div>
				<!-- end logout button -->
		...
		<aside id="left-panel" style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% ); margin: 0px 0px 0px 0px;">
			...
			<small style="color:white;font-size:10px; margin: 0px 0px 0px 0px;">Super Administrator</small></p>
				</span>
			...
			<nav>
				<ul>
					...
					?>
					<li <?=active($that, 'dashboard')?> style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );">
					...
					<li <?=active($that, array('dashboard_merchant_internal', 'master_client', 'master_atm', 'master_location', 'master_location_detail', 'master_require_part'))?> style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );">
					...
					<li <?=active($that, array('master_staff', 'master_attendance', 'master_user', 'master_absen_location'))?> style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );">
						<a href="#" class="zoomsmall">
						...
						<ul>
							<li <?=active($that, 'master_staff')?>>
								<a href="<?=base_url()?>master_staff.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/userpro.png" height="15" width="15" />Petugas / Staff</a>
							</li>
					...
					<li <?=active($that, array('master_inventory', 'transaction_in', 'transaction_out'))?> style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );">
						<a href="#" class="zoomsmall">
						...
						<ul>
							<li <?=active($that, 'master_inventory')?>>
								<a href="<?=base_url()?>master_inventory.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/folset.png" height="15" width="15" />Inventory Stock</a>
							</li>
					...
					<li <?=active($that, array('trans_schedule', 'trans_staff', 'master_item', 'master_news'))?> style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );">
						<a href="#" class="zoomsmall">
					...
					<li <?=active($that, array('new_ticket', 'status_ticket', 'master_jobcard', 'trouble_category', 'trouble_sub_category'))?> style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );">
						<a href="#" class="zoomsmall">
					...
					<li <?=active($that, array('report_attendance', 'inventory_report', 'report_maintenance', 'jobcard_report'))?> style="background-image: linear-gradient( 171.8deg,  rgba(5,111,146,1) 13.5%, rgba(6,57,84,1) 78.6% );">
						<a href="#" class="zoomsmall">
						...
						<ul>
							...
							<li <?=active($that, 'report_maintenance')?>>
								<a href="<?=base_url()?>report_maintenance.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/pdf.png" height="15" width="15" />Technical Report</a>
							</li>
							<li <?=active($that, 'jobcard_report')?>>
								<a href="<?=base_url()?>jobcard_report.assindo" class="zoomsmall"><img style="float: left; margin: 3px 5px 0px -10px;" src="<?=base_url()?>seipkon/assets/img/pdf.png" height="15" width="15" />Jobcard Report</a>
							</li>
						</ul>
					</li>		
		...
		<!-- PAGE FOOTER -->
		<div class="page-footer" style="height:35px">
			<div class="row">
...
</html><?php /**PATH D:\xampp\htdocs\2021\JAN-W3\ATMSERV-ASSINDO\coresys\views/layouts/master.blade.php ENDPATH**/ ?>