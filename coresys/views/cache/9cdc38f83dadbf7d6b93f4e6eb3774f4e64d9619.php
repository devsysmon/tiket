	...
	<section id="widget-grid" class="">
		...
		<div class="container content_form" hidden>
			<form action="<?=base_url()?>master_client/insert" style="margin-bottom: 10px" autocomplete="off" id="data" method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					<label class="control-label" for="pic">C S E/P I C</label>
					<input type="text" name="pic" placeholder="C S E/P I C" class="pic form-control" required />
				</div>
				<div class="form-group">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\2021\JAN-W3\ATMSERV-ASSINDO\coresys\views/pages/master_client/index.blade.php ENDPATH**/ ?>