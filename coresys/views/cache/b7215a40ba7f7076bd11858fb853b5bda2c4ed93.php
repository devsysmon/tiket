	...
	<hanzmobview>
		<article class="btn-group col-sm-12">
			<div class="navbar navbar-default" style="background-image: linear-gradient( 176.4deg,rgba(237,135,33,1) 28.8%, rgba(244,62,62,1) 99% );border-radius: 5px 5px 0px 0px;">
				...
				<div class="col-sm-3" style="margin: 5px 0px 0px 0px;">
				<a href="trouble_category.ins" class="btn btn-default btn-circle zoomsmall active">
				...
				<a href="trouble_sub_category.ins" class="btn btn-default btn-circle btn-sm zoomsmall">
			...
			<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin: -20px 0px 0px 0px;">
				...
				<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0" 	
					...
					<header style="background: linear-gradient(to bottom, #323232 0%, #3F3F3F 0%, #1C1C1C 150%);">
						...
						<h2 style="color:white; margin: -1px 0px 0px 10px;"><b>sd	</b></h2>
					</header>
					<!-- widget div-->
					<div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\2021\JAN-W3\ATMSERV-ASSINDO\coresys\views/pages/trouble_category/index.blade.php ENDPATH**/ ?>