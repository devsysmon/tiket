...
<div class="inbox-info-bar">
	<div class="row">
		<div class="col-sm-9">
			<img src="<?=BASE_URL?>img/avatars/5.png" alt="me" class="away">
...
<div class="inbox-message">
	...
	<br>	
	<img src="<?=BASE_URL?>img/logo-blacknwhite.png" height="20" width="auto" style="margin-top:7px; padding-right:9px; border-right:1px dotted #9B9B9B;" />
</div>
	...
	<ul class="inbox-download-list">
		<li>
			<div class="well well-sm">
				<span>
					<img src="<?=BASE_URL?>img/demo/sample.jpg">
				</span>
				<br>
...
<script type="text/javascript">
	...
	$(".replythis").click(function(){
		loadURL("<?=base_url()?>template/email/email_reply.html", $('#inbox-content > .table-wrap'));
	})
