...
<form enctype="multipart/form-data" action="dummy.php" method="POST" class="form-horizontal" id="email-compose-form">
	...
	<div class="inbox-message no-padding">
		...
		<div id="emailbody">
				...
				<br><br><br><br><br>Thanks,<br><strong>John Doe</strong><br><br><small>CEO - SmartAdmin <br> 231 Ajax Rd, Detroit MI - 48212, USA<br><i class="fa fa-phone"> (313) 647 4761</i></small><br><img src="<?=BASE_URL?>img/logo-blacknwhite.png" height="20" width="auto" style="margin-top:7px; padding-right:9px; border-right:1px dotted #9B9B9B;" />		
		</div>	
	</div>
...
<div class="email-infobox">
	...
	<ul class="list-inline">
		<li><img src="<?=BASE_URL?>img/avatars/5.png" alt="me" width="30px"></li>
		<li><img src="<?=BASE_URL?>img/avatars/3.png" alt="me" width="30px"></li>
		<li><img src="<?=BASE_URL?>img/avatars/sunny.png" alt="me" width="30px"></li>
	...
	$(".show-next").click(function () {
	 ...
	 $("#send").click(function () {
	    ...
	    setTimeout(function () {
			...
			loadURL("<?=base_url()?>template/email/email_list.html", $('#inbox-content > .table-wrap'))
