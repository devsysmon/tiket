			...
			<div class="col-md-8">
				<div class="page-box">
					<div class="form-example">
						<img style="float: left; margin: -5px 10px 0px 0px;" src="<?=base_url()?>seipkon/assets/img/adddata.png" height="35" width="30" /><h3>Data Mesin ATM</h3>
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<input type="text" placeholder="" class="form-control" id="idatm" name="idatm" value="<?=$idatm?>" required>
											</div>
										</div>
										<div class="col-md-12">
											<div class="form-group">
												<label class="control-label">Branch :</label>
												<input type="text" placeholder="" class="form-control" id="cabang" name="cabang" value="<?=$cabang?>" required>
											</div>
										</div>
										<div class="col-md-12">
											<div class="form-group">
												<label class="control-label">Location :</label>
												<input type="text" placeholder="" class="form-control" id="lokasi" name="lokasi" value="<?=$lokasi?>" required>
											</div>
										</div>
										<div class="col-md-12">
											<div class="form-group">
												<label class="control-label">Address :</label>
												<input type="text" placeholder="" class="form-control" id="alamat" name="alamat" value="<?=$alamat?>" required>
											</div>
										</div>
										<div class="col-md-12">
											<div class="form-group">
												<label class="control-label">Location Category :</label>
												<div id="slWrapper" class="parsley-select wd-250">
													<select class="form-control" data-placeholder="Choose one" data-parsley-class-handler="#slWrapper" data-parsley-errors-container="#slErrorContainer" id="kategori" name="kategori" required>
														<option value="">Choose...</option>
														<option <?=($kategori=="INSTANSI/KANTOR" ? "selected" : "")?>>INSTANSI/KANTOR</option>
														<option <?=($kategori=="INDUSTRI/PABRIK" ? "selected" : "")?>>INDUSTRI/PABRIK</option>
														<option <?=($kategori=="HOTEL/RESTORAN" ? "selected" : "")?>>HOTEL/RESTORAN</option>
														<option <?=($kategori=="TRANSPORTASI" ? "selected" : "")?>>TRANSPORTASI</option>
														<option <?=($kategori=="PERKANTORAN" ? "selected" : "")?>>PERKANTORAN</option>
														<option <?=($kategori=="UNIVERSITAS" ? "selected" : "")?>>UNIVERSITAS</option>
														<option <?=($kategori=="SPBU/REST AREA" ? "selected" : "")?>>SPBU/REST AREA</option>
														<option <?=($kategori=="SUPERMARKET" ? "selected" : "")?>>SUPERMARKET</option>
													</select>
											...
											<div class="form-group">
												...
												<div id="slWrapper" class="parsley-select wd-250">
													<select class="form-control" data-placeholder="Choose one" data-parsley-class-handler="#slWrapper" data-parsley-errors-container="#slErrorContainer" id="status" name="status" required>
														<option value="">Choose...</option>
														<option <?=($status=="ON" ? "selected" : "")?>>ON</option>
														<option <?=($status=="OFF" ? "selected" : "")?>>OFF</option>
													</select>
													<div id="slErrorContainer"></div>
												</div>
											</div>
										...
										<div class="col-md-12">
											<div class="form-group">
												<label class="control-label">Foto ATM :</label>
												<input type="text" placeholder="" class="form-control" id="" name="alamat" value="" >
											</div>
										</div>
										<div class="col-md-12">
											<div class="form-group">
