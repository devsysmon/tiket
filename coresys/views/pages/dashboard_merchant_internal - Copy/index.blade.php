...
<div class="row">
	<article class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="margin: -20px 0px 0px 0px;">
		<div id="ribbon" style="background: linear-gradient(to bottom, #00c6ff, #0072ff);">
			<span class="ribbon-button-alignment pull-left" style="margin: 0px 0px 0px 0px; "><small style="color:white;font-size:14px; font-weight: bold;">Client Dashboard Monitoring</small>
			</span> 
...
@section('javascript')
	<script type="text/javascript">
		...
		function openDataUI(view='default') {
			if(view=='default') {
				$('#iframe').attr('src', '<?=base_url()?>dashboard_merchant_internal/view_child_atm');
			} else if(view=='ticket') {
				$('#iframe').attr('src', '<?=base_url()?>dashboard_merchant_internal/view_child_ticket');
			} else if(view=='attend') {
				$('#iframe').attr('src', '<?=base_url()?>dashboard_merchant_internal/view_child_attend');
			} else if(view=='part') {
				$('#iframe').attr('src', '<?=base_url()?>dashboard_merchant_internal/view_child_part');
			}
		}
