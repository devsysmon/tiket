...
@section('content')
	<div class="container-fluid">
		...
		<br>
		<a href="<?=base_url()?>dashboard" class="btn btn-primary pull-right" style="margin-top: -5px"><img style="float: left; margin: 2px 5px 0px 0px;" src="<?=base_url()?>seipkon/assets/img/navigation-180.png" height="25" width="20" /><b>Back To Dashboard</b></a>
		<div class="row">
			<div class="col-md-12">
